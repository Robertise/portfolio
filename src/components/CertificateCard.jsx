...
const CertificateCard = ({ cert }) => {
  ...
  return (
    <div
      className="relative h-76 cursor-pointer"
      ...
      >
        ...
        >
          ...
          <div className="flex flex-col flex-1 p-5 gap-1">
            <p className="text-sm md:text-base font-semibold text-(--accent) uppercase tracking-wide truncate">
              {cert.issuer}
            </p>
            <h3 className="text-sm md:text-base font-bold text-(--text-primary) leading-snug line-clamp-2">
              {cert.title}
            </h3> 
          </div>
        ...
        >
          <div>
            <p className="text-sm md:text-base font-semibold text-(--accent) uppercase tracking-wide mb-1">
              {cert.issuer}
            </p>
            <h3 className="text-sm md:text-base font-bold text-(--text-primary) leading-snug mb-3">
              {cert.title}
            </h3>
